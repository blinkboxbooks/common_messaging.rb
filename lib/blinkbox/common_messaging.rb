...
module Blinkbox
  ...
  module CommonMessaging
    ...
    class Queue
      ...
      # @param [Boolean] :validate Should inbound messages be validated against schema and automatically rejected if they fail? (default: true)
      ...
      def subscribe(block: true, validate: true)
